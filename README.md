...
- 가능하면 큰 화면에서 모드 배치하고, 점점 줄여가면서 배치하기를 권장
...
- 정리
  ...
  - `영역너비(650px) / 자인 전체영역 너비(1280px) * 100 = 결과 vw`
  - `영역너비(400px) / 자인 전체영역 너비(1280px) * 100 = 결과 vw`
...
- VSCode 설치: `Live Sass Compiler`
- 실습
- css 폴더 / test.scss 파일생성
- VSCode 하단에 `watch Sass` 를 클릭함.
